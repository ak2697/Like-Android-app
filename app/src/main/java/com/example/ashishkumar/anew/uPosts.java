...
public class uPosts extends ArrayAdapter<User> {
    private Activity context;
    private List<User> userPosts;

    public uPosts(Activity context, List<User> userPosts)
    {
        super(context,R.layout.activity_u_posts,userPosts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item=inflater.inflate(R.layout.activity_u_posts,null,true);
